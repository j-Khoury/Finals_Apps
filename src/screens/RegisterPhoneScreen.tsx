...
const RegisterPhoneScreen: React.FC<{navigation: any}> = ({navigation}) => {
  const [selectedCountry, setSelectedCountry] = useState<Country>(
    CountryCode.find((country: Country) => country.name === 'India'),
  );
  const [inputsContainerY, setInputsContainerY] = useState<number>(0);
  ...
  return (
    <View
      ...
      onStartShouldSetResponder={({nativeEvent: {pageX, pageY}}) =>
        closeDropdown(pageX, pageY) || false
      }>
      <StatusBar
