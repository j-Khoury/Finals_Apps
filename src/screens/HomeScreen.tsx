...
const HomeScreen: React.FC<{navigation: any}> = ({navigation}) => {
  ...
  useEffect(() => {
    const unsubscribe = navigation.addListener('focus', () => {
      RestaurantService.getRestaurants().then((response: any) => {
        if (response?.status) {
    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.listContainer}>
        <View style={styles.horizontalListContainer}>
          ...
          <FlatList
            ...
            renderItem={({item}) => (
              ...
              name={''} images={{
                poster: ''
              }} tags={[]} distance={''} time={''} {...item}
              navigate={(restaurantId: string) => navigation.navigate('Restaurant', { restaurantId })}              />
            )}
          />
        </View>
        ...
        {restaurants?.map(item => (
          <RestaurantMediumCard name={''} images={{
            logo: ''
          }} time={''} distance={''} tags={[]} {...item} key={item?.id} />
        ))}
