...
interface RemoveBookmarkAction extends Action<'REMOVE_BOOKMARK'> {
  ...
  [extraProp: string]: any; // Add this line to include the index signature
}

export const BookmarkAction = {
  removeBookmark: (payload: { restaurantId: string }): RemoveBookmarkAction => ({
  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity activeOpacity={0.8} onPress={() => navigate(id)}>
        <Image
          source={{ uri: StaticImageService.getPoster({ poster: images?.poster || '' }) }}
      ...
      <View style={styles.labelContainer}>
        ...
        <View style={styles.buttonLabelRow}>
          ...
          <View style={styles.rowAndCenter}>
            <Ionicons name="ios-time-outline" color={Colors.GOOGLE_BLUE} size={15} />
            <Text style={styles.ratingText}>20 mins</Text>
          </View>
          <View style={styles.rowAndCenter}>
            <Ionicons name="location-outline" color={Colors.SECONDARY_GREEN} size={15} />
